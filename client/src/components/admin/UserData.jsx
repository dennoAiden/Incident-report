...
export default function UserData() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch('https://incident-report-backend-akvl.onrender.com/users');
        if (!response.ok) {
  ...
  const banUser = async (userId) => {
    try {
      const response = await fetch(`https://incident-report-backend-akvl.onrender.com/users/${userId}/ban`, {
        method: 'PATCH',
        headers: {
  ...
  const unbanUser = async (userId) => {
    try {
      const response = await fetch(`https://incident-report-backend-akvl.onrender.com/users/${userId}/unban`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deleteUser = (userId) => {
    ...
    toast.promise(
      fetch(`https://incident-report-backend-akvl.onrender.com/user/${userId}`, {
        method: 'DELETE',
      }).then((response) => {
        if (!response.ok) {
