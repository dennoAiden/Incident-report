...
export default function ReportedIncidents() {
  ...
  useEffect(() => {
    const fetchIncidents = async () => {
      try {
        const response = await fetch('https://incident-report-backend-akvl.onrender.com/incidents');
        ...
        const emergencyResponse = await fetch('https://incident-report-backend-akvl.onrender.com/emergency-reporting');
  ...
  const updateStatus = async (id, newStatus, type) => {
    const url =
      type === 'emergency'
        ? `https://incident-report-backend-akvl.onrender.com/emergency/${id}/status`
        : `https://incident-report-backend-akvl.onrender.com/incident/${id}/status`;
